...
use Per3evere\Nsq\Logger\LoggerInterface;
use Per3evere\Nsq\Lookup\LookupInterface;
use Per3evere\Nsq\Connection\ConnectionInterface;
use Per3evere\Nsq\Dedupe\DedupeInterface;
use Per3evere\Nsq\RequeueStrategy\RequeueStrategyInterface;
